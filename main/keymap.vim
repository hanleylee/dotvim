...
" 上下移动文字
nnoremap <C-j> :call hl#operate#move_line('n', 'down')<CR>
vnoremap <C-j> :call hl#operate#move_line('v', 'down')<CR>
nnoremap <C-k> :call hl#operate#move_line('n', 'up')<CR>
vnoremap <C-k> :call hl#operate#move_line('v', 'up')<CR>
