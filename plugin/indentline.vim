...
let g:indentLine_fileTypeExclude = ['txt', 'markdown', 'json', 'csv', 'asciiart', 'rst'] " 排除类型
let g:indentLine_bufNameExclude = ['_.*', '*.md', '*.json', '*.csv', '*.asciiart', '*.rst']
let g:indentLine_bufTypeExclude = ['help', 'terminal', 'markdown', 'json', 'csv', 'asciiart', 'rst']
