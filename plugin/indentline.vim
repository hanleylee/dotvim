...
let g:indentLine_fileTypeExclude = ['txt', 'markdown', 'json', 'csv', 'asciiart'] " 排除类型
let g:indentLine_bufNameExclude = ['_.*', '*.md', '*.json', '*.csv', '*.asciiart']
let g:indentLine_bufTypeExclude = ['help', 'terminal', 'markdown', 'json', 'csv', 'asciiart']
